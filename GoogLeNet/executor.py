...
import pandas as pd
from GoogLeNet.transformation import *
import timeit
...
class Executor(BaseExecutor):
    ...
    def build_model(self):
        ...
        self.model = GoogLeNet(num_classes=self.NUM_CLASSES)
        ...
        self.optimizer = torch.optim.SGD(self.model.parameters(), lr=0.01, momentum=0.9, weight_decay=0.0002, nesterov=True)
